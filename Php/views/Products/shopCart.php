                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="shoping__cart__btns" style="display: flex; justify-content:space-between ;">
                            ...
                            <!-- <input type="submit" name="submit" value="BUY" class="primary-btn" id="submit" style="border:0px;"> -->
                            <!-- <a href="#" class="primary-btn cart-btn cart-btn-right" id="add-to-cart"><span class="icon_loading"></span>
                                Upadate Cart</a> -->
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="shoping__continue">
                            <div class="shoping__discount">
                                <h5>Discount Codes</h5>
                                    <input type="text" name="coupon" style="padding: 10px; border: 0px; background-color:#f5f5f5 ;" placeholder="Enter your coupon code">

                    ...
                    <div class="product__discount">
                        ...
                        <div class="row">
                            <div class="product__discount__slider owl-carousel">
                                <?php foreach($saleOff as $sale):?>
                                    <div class="col-lg-4">
                                        <div class="product__discount__item">
                                            <div class="product__discount__item__pic set-bg"
                                                data-setbg="/template/oganiMaster/img/product/discount/pd-3.jpg">
                                                <div class="product__discount__percent">-<?=$sale['saleOff']?>%</div>
                                            ...
                                            <div class="product__discount__item__text">
                                                ...
                                                <div class="product__item__price">$ <?= abs(($sale['price'] / 100 * $sale['saleOff']) - $sale['price']) ?> <span>$<?= $sale['price'];?></span></div>
                                            </div>
                                        </div>
                                    </div>
                                <?php endforeach;?>                                
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    ...
                                    <div class="product__item__text">
                                        <h6><a href="/shopDetails/<?=$product['id']?>"><?=$product['name']?></a></h6>
                                        <h5>$ <?=$product['price']?></h5>
                                    </div>
                                </div>
                            </div>
